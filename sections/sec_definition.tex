...
This section introduces a generic agent-based architecture for modular digital twins. It presents a high-level component view of the framework, clarifying the separation between the digital application, organizational structure, agents, the communication section, and the environment that mediates interaction with the physical system. It then formalizes the agent model and the surrounding coordination mechanisms (organization, communication, and environment) to provide a consistent set of definitions and notation for the proposed framework and experiments.
