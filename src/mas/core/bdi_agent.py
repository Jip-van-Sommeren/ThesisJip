...
from .agent import Agent, AgentId, Goal
...
class BDIAgent(Agent):
    ...
    def select_intentions(self):
        ...
        if len(self.intentions) < self.max_intentions:
            ...
            existing_goal_conditions = {i.goal.condition for i in self.intentions}
    ...
    def generate_plan(self, goal: Goal) -> List[str]:
        ...
        Simple implementation - can be extended with more sophisticated planning.
        """
        # Check if goal type suggests a specific plan
    ...
    def decide_action(self) -> str:
        ...
        """
        # Perform intention selection (desire filtering)
        ...
        if not self.intentions:
            ...
            return self.decision.deliberate(self.state, self.goals, available_actions)
    ...
    def goal_achieved(self, goal: Goal, environment_state: Dict) -> bool:
        ...
        Simple implementation - can be extended with more sophisticated reasoning.
        """
    ...
    def intention_feasible(self, intention: Intention) -> bool:
        ...
        return intention.goal.active and not self.goal_achieved(intention.goal, {})
    ...
    def get_bdi_status(self) -> Dict:
        ...
        return {
            ...
            "intentions_status": {
                status.value: len([i for i in self.intentions if i.status == status])
...
__all__ = ["BDIAgent", "Intention", "IntentionStatus"]
